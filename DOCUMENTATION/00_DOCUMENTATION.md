...
Welcome to the complete guide for the Hyprland window manager configuration used in **Luna-Hyprdots**. This documentation covers everything you need to understand and customize this advanced Linux desktop setup.
...
2. **Install Luna-Hyprdots**: Run the installation script from the [official repository](https://github.com/Arunachalam-gojosaturo/luna-hyprdots)
   ```bash
...
- **Luna-Hyprdots GitHub:** https://github.com/Arunachalam-gojosaturo/luna-hyprdots
- **Luna-Hyprdots Discord:** https://discord.gg/fMGt4vH6s5
- **Official Hyprland Wiki:** https://wiki.hypr.land/
- **Hyprland GitHub:** https://github.com/hyprwm/Hyprland
- **Hyprland Forum:** https://forum.hypr.land/

**Luna-Hyprdots Project Creator:** Arunachalam-gojosaturo
