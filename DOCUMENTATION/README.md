...
## Part of **Luna-Hyprdots** by Arunachalam-gojosaturo

> **Note:** This documentation is part of the [**Luna-Hyprdots**](https://github.com/Arunachalam-gojosaturo/luna-hyprdots) project by **Arunachalam-gojosaturo**.

## Complete Beginner's Guide to Hyprland

Welcome! This documentation provides comprehensive tutorials and guides for understanding and customizing the Hyprland window manager configuration used in Luna-Hyprdots.
...
> This entire documentation covers the Lua config format used by Luna-Hyprdots.
...
2. **Install Luna-Hyprdots**: Run the official installation script from the [repository](https://github.com/Arunachalam-gojosaturo/luna-hyprdots)
   ```bash
...
That's it! You're using Hyprland with Luna-Hyprdots configuration.

### Update Guide

**Update Luna-Hyprdots** To update the config and its related pkgs. Simply run luna-hyprdots in the terminal:
...
This is the Hyprland configuration from the **Luna-Hyprdots** project by **Arunachalam-gojosaturo**.
...
**Learn more:** [Luna-Hyprdots GitHub](https://github.com/Arunachalam-gojosaturo/luna-hyprdots)
...
1. **[00_DOCUMENTATION.md](./00_DOCUMENTATION.md)** - Start here!
   ...
   - Link to official Luna-Hyprdots repository
...
**For Luna-Hyprdots specific issues:** [GitHub Issues](https://github.com/Arunachalam-gojosaturo/luna-hyprdots/issues)

**For Hyprland general questions:** [Hyprland Community](https://forum.hypr.land/)

**Original Project:** [Luna-Hyprdots Repository](https://github.com/Arunachalam-gojosaturo/luna-hyprdots)

**Project Creator:** **Arunachalam-gojosaturo**
