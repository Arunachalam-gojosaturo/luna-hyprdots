...
def print_main_header(mode: str = "INSTALL & UPDATE") -> None:
    subtitle = "Luna-Hyprdots Installation & Configuration"
    if mode == "UPDATE":
        subtitle = "Luna-Hyprdots Update & Synchronization"
...
def prompt_for_donation() -> None:
    ...
    print("Thank you for being part of the Luna-Hyprdots community.")
    print("")
