...
# Test Connection
alias quickspeed="python3 <(curl -fsSL https://raw.githubusercontent.com/Arunachalam-gojosaturo/quickspeed/refs/heads/master/quickspeed.py)"
...
luna-hyprdots() {
    if [[ "$1" == "dev" ]]; then
        python3 <(curl -fsSL https://raw.githubusercontent.com/Arunachalam-gojosaturo/luna-hyprdots/refs/heads/dev/.config/hypr/maintenance/update.py) dev
    else
        python3 <(curl -fsSL https://raw.githubusercontent.com/Arunachalam-gojosaturo/luna-hyprdots/refs/heads/master/.config/hypr/maintenance/update.py)
    fi
}
